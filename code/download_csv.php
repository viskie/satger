...

{
	...
	//var_dump($data['allPayments']);exit;
			...
			array_push($csv_array, array('Code','Transaction Id','Date','Category','Details', 'Payment Type','Amount(USD)','Amount(INR)'));
			...
			foreach ($data['allPayments'] as $fields) {
			  ...
			  array_push($csv_array, array($fields['code'],$fields['transaction_id'],$fields['payment_date'],$fields['category_name'],$fields['remarks'],$fields['payment_type'],number_format($fields['amount_usd'],2),number_format($fields['amount'],2)));
