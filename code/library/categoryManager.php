...
class CategoryManager extends commonObject
{
	...
	function getAllPaymentCategories($show='1')
		...
		function get_allcounts_payment()
		{
			$arr_counts = array();
		...
		function restore_payment_category($id)
		{
			$change_data = array (
									'is_active' => 1,							
									); 
			$change_data['pc_id'] = $id;
			$updateQry=$this->getUpdateDataString($change_data,"payment_category","pc_id");
			updateData($updateQry);
